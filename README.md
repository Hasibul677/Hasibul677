...
I am a **Software Engineer** specializing in frontend development with **4+ years of professional experience**.  
I build **high-performance, scalable, and responsive web applications** using modern technologies.

I am passionate about:
- ⚡ Creating fast and interactive user interfaces  
- 🧩 Writing clean, maintainable, and scalable code  
- 🎯 Delivering smooth and intuitive user experiences  
- 🚀 Working with modern React ecosystem (React, Next.js, TypeScript)
...
[![Profile Views](https://visitcount.itsvg.in/api?id=Hasibul677&icon=0&color=0)](https://visitcount.itsvg.in)
